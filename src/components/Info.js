...
return (
<div className="info">
    <p className="bio">Shea Fitzpatrick is a designer with an affinity for visual systems and understated narratives. Currently a Senior Web Designer at the New York Times.</p>
