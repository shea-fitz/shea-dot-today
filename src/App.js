...
function App() {
  ...
  return (
    ...
    <Fade>   
      ...
      <div className="footer"><span>♫ I built this site from scratch with React.js and the <a href="https://www.are.na/developers/explore" target="_blank">Are.na API</a>. Last updated June 5, 2026 ♫</span>
